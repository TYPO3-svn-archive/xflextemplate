...
t3lib_div::loadTCA('tt_content');
$TCA['tt_content']['types'][$_EXTKEY.'_pi1']['showitem']='CType;;4;;1-1-1,header;LLL:EXT:lang/locallang_general.php:LGL.name;;;2-2-2,xtemplate;;4;;1-1-1'.$strType.',--div--;LLL:EXT:xflextemplate/locallang_db.xml:tt_content.CType_pi1';
